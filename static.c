...
// Function to generate the Mandelbrot image for the entire image
void generate_mandelbrot(uint8_t* buffer, int start_row, int end_row) {
...
int main(int argc, char** argv) {
    ...
    generate_mandelbrot(local_buffer, start_row, end_row);
